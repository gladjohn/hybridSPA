...
1. Replace the `Tenant ID` value under `Authority`
...
> The sample redeems the Spa Auth Code from the initial token aquisition. If you want to add more client side functionallity, please refer to the [MSAL JS Browser Sample for Hybrid SPA](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/samples/msal-browser-samples/HybridSample)
